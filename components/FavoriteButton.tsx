    ...
    <>
      {!showProduct ? (
        ...
        <button
          ...
          className="group relative hover:text-shop_dark_blue hoverEffect border border-shop_dark_blue/80 hover:border-shop_dark_text-shop_dark_blue p-1.5 rounded-sm"
        >
          {existingProduct ? (
            <Heart
              fill="#1f1f1f"
